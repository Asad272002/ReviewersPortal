  ...
  const checkIfAwardedTeamMember = async () => {
    try {
      ...
      if (response.ok) {
        ...
        const isTeamLeader = data.data.awardedTeams?.some((team: any) => {
    ...
    <ProtectedRoute>
      <div className="flex flex-col h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 relative overflow-hidden">
        ...
        <div className="flex flex-1 relative z-10 overflow-hidden">
          ...
          <main
            className={`flex-1 p-4 sm:p-6 lg:p-8 overflow-y-auto animate-fadeIn relative ${(user?.role === 'team' && isAwardedTeamMember) ? 'max-w-4xl mx-auto' : ''} ${!(user?.role === 'team' && isAwardedTeamMember) ? 'lg:ml-0' : ''}`}
          >
            {user?.role === 'reviewer' ? (
              <>
                <HeroSection />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-6 relative z-10">
                  <InfoCard
                    ...
                    content={['Important Updates', 'Latest Posts']}
                  ...
                  <InfoCard
                    ...
                    content={['Project Requirements', 'Technical Specifications', 'Guidelines']}
                  ...
                  <InfoCard
                    ...
                    content={['Helpful Links', 'Tools & Templates', 'Reference Materials']}
                  ...
                  <InfoCard
                    ...
                    LucideIcon={Vote}
                    content={['Review Proposals', 'Cast Your Vote', 'View Results']}
                    linkText="Vote now"
                  ...
                  <InfoCard
                    ...
                    content={['Assessments', 'Timed quizzes', 'Skills check']}
                    linkText="Open Tests"
                  ...
                  <InfoCard
                    ...
                    content={['Workflows', 'Procedures', 'Guidelines']}
                  ...
                  <InfoCard
                    ...
                    content={['Get Help', 'Submit Tickets', 'FAQ']}
              ...
              <div className="min-h-screen flex items-center justify-center">
                <div className="w-full">
                  <div className="text-center mb-8">
                    <h1 className="font-montserrat font-bold text-4xl text-white mb-4">Welcome to Review Circle</h1>
                    <p className="font-montserrat text-xl text-gray-300">Connect with your assigned reviewer</p>
                  </div>
              ...
              <div className="min-h-screen flex flex-col items-center justify-center py-10">
                <div className="w-full max-w-7xl">
                  <div className="text-center mb-8">
                    <h1 className="font-montserrat font-bold text-4xl text-white mb-4">Admin Dashboard</h1>
                    <p className="font-montserrat text-xl text-gray-300">System administration and management</p>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 relative z-10">
                    <InfoCard
                      title="Announcements"
                      icon="announcement-header-icon.svg"
                      content={['Create announcements', 'Manage posts', 'System notifications']}
                    ...
                    <InfoCard
                      ...
                      icon="admin-icon.svg"
                      content={['Manage user accounts', 'Role assignments', 'System settings']}
              ...
              <>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-6 relative z-10">
                  ...
                  <InfoCard
                    ...
                    icon="requirement-header-icon.svg"
                    content={['Key guidelines for Proposers', 'Proposal document Checklist', 'Document template Links']}
                    linkText="View Documents"
                    linkHref="/documents"
                  />
                </div>
                ...
                <div className="mt-8 p-6 bg-[#1A0A3A] rounded-xl border border-[#9D9FA9] relative z-10">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="p-4 bg-[#2A1A4A] rounded-lg border border-[#9D9FA9] hover:border-blue-400/70 hover:bg-[#3A2A5A] transition-all duration-300 cursor-pointer group">
                      <h3 className="font-montserrat font-medium text-white mb-2 group-hover:text-blue-200 transition-colors">
                        Resources
                      </h3>
                      <p className="font-montserrat text-gray-100 group-hover:text-white transition-colors">
                        Access review tools and reference materials
                      </p>
                    </div>
                    <div className="p-4 bg-[#2A1A4A] rounded-lg border border-[#9D9FA9] hover:border-purple-400/70 hover:bg-[#3A2A5A] transition-all duration-300 cursor-pointer group">
                      <h3 className="font-montserrat font-medium text-white mb-2 group-hover:text-purple-200 transition-colors">
                        Contact & Support
                      </h3>
                      <p className="font-montserrat text-gray-100 group-hover:text-white transition-colors">
                        Get help with the review process
                      </p>
                    </div>
                  </div>
                </div>
