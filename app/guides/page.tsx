...
export default function Guides() {
  ...
  const publishedGuides = Array.isArray(guides) ? guides.filter(guide => guide.isPublished).sort((a, b) => a.order - b.order) : [];
              ...
              <div className="space-y-6">
                {publishedGuides.length > 0 ? (
                  publishedGuides.map((guide, index) => (
                    <div key={guide.id} className={index < publishedGuides.length - 1 ? "border-b border-[#9D9FA9] pb-6" : ""}>
                      ...
                      {guide.attachments && guide.attachments.length > 0 && (
                        <div className="ml-9 mt-3">
                          ...
                          <div className="flex flex-wrap gap-2">
                            {guide.attachments.map((attachment, idx) => (
